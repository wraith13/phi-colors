...
describe('phiColors', function () {
    ...
    describe('regulateHsla()', function () {
        it("regulateHsla({h:0,s:0,l:0,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: 0, s: 0, l: 0, a: 0 }), { h: 0, s: 0, l: 0, a: 0 }); });
        it("regulateHsla({h:0.5,s:0.5,l:0.5,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: 0.5, s: 0.5, l: 0.5, a: 0 }), { h: 0.5, s: 0.5, l: 0.5, a: 0 }); });
        it("regulateHsla({h:-0.5,s:-0.5,l:-0.5,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: -0.5, s: -0.5, l: -0.5, a: 0 }), { h: -0.5, s: 0, l: 0, a: 0 }); });
        it("regulateHsla({h:10,s:0,l:0,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: 10, s: 0, l: 0, a: 0 }), { h: -2.5663706144, s: 0, l: 0, a: 0 }); });
        it("regulateHsla({h:100,s:0,l:0,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: 100, s: 0, l: 0, a: 0 }), { h: -0.5309649149, s: 0, l: 0, a: 0 }); });
        it("regulateHsla({h:-10,s:0,l:0,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: -10, s: 0, l: 0, a: 0 }), { h: 2.5663706144, s: 0, l: 0, a: 0 }); });
        it("regulateHsla({h:-100,s:0,l:0,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: -100, s: 0, l: 0, a: 0 }), { h: 0.5309649149, s: 0, l: 0, a: 0 }); });
        it("regulateHsla({h:0,s:10,l:0,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: 0, s: 10, l: 0, a: 0 }), { h: 0, s: 0, l: 0, a: 0 }); });
        it("regulateHsla({h:0,s:0,l:10,a:0})", function () { return assertDeepNearEqual(source_1.phiColors.regulateHsla({ h: 0, s: 0, l: 10, a: 0 }), { h: 0, s: 0, l: 1, a: 0 }); });
    });
